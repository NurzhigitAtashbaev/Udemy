...
class BaseSettings(BaseModel):
    ...
    class Config(BaseConfig):
        ...
        def prepare_field(cls, field: ModelField) -> None:
            ...
            env = field_info_from_config.get('.env.py') or field.field_info.extra.get('.env.py')
            if env is None:
                if field.has_alias:
                    warnings.warn(
                        'aliases are no longer used by BaseSettings to define which environment variables to read. '
                        'Instead use the ".env.py" field setting. '
                ...
                raise TypeError(f'invalid field .env.py: {env!r} ({display_as_type(env)}); should be string, list or set')
                ...
                if env_val is None:
                    ...
                    try:
                        ...
                        if not allow_parse_failure:
                            raise SettingsError(f'error parsing .env.py var "{env_name}"') from e
