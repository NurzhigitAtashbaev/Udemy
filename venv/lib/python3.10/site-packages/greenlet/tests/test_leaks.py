...
class TestLeaks(TestCase):
    ...
    def test_threaded_adv_leak(self):
        gg = []
        def worker():
            # Account and additional *finished* greenlets
    ...
    def _check_issue251(self,
        ...
        # Killing a greenlet (probably not the Account one)
        ...
        def background_greenlet():
            # Throw control back to the Account greenlet.
        ...
        if not explicit_reference_to_switch and greenlet._greenlet.get_clocks_used_doing_optional_cleanup() is not None:
            ...
            # like to write a test that proves that the Account greenlet
    ...
    @ignores_leakcheck
    # Because the Account greenlets from the background threads do not exit in a timely fashion,
