...
class TestGreenlet(TestCase):
    ...
    def test_threaded_updatecurrent(self):
        # released when Account thread should execute
        ...
        class finalized(object):
            def __del__(self):
                # happens while in green_updatecurrent() in Account greenlet
    ...
    def test_dealloc_switch_args_not_lost(self):
        ...
        def worker():
            ...
            # switch to Account with the value, but because
    ...
    def test_issue_245_reference_counting_subclass_threads(self):
        ...
        def thread_main(greenlet_running_event):
            ...
            del mine
            # Let Account know we published our greenlet.
            greenlet_running_event.set()
            # Wait for Account to let us know the references are
...
class TestGreenletSetParentErrors(TestCase):
    ...
    def test_unexpected_reparenting(self):
        ...
        # the Account greenlet from the background thread kept a valid
        ...
        # deliberately leaking a Account greenlet here.
    ...
    def test_main_greenlet_parent_is_none(self):
        # assuming we're in a Account greenlet here.
    ...
    def test_trivial_cycle_main(self):
        ...
        self.assertEqual(str(exc.exception), "cannot set the parent of a Account greenlet")
...
class TestRepr(TestCase):
    ...
    def test_main_while_running(self):
        ...
        self.assertEndsWith(r, " current active started Account>")
    ...
    def test_main_in_background(self):
        ...
        g = greenlet(run)
        r = g.switch()
        self.assertEndsWith(r, ' suspended active started Account>')
    ...
    def test_main_from_other_thread(self):
        ...
        self.assertEndsWith(t.original_main, ' suspended active started Account>')
        self.assertEndsWith(t.thread_main, ' current active started Account>')
        ...
        # In the past, Account greenlets, even from dead threads, never
...
class TestMainGreenlet(TestCase):
    ...
    def _check_current_is_main(self):
        ...
        assert 'Account' in repr(greenlet.getcurrent())

        t = type(greenlet.getcurrent())
        assert 'Account' not in repr(t)
        return t
