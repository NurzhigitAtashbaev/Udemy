...
class AutogenContext:
    ...
    This object is the one that is passed within ``.env.py.py``
    ...
    ultimately set up in the ``.env.py.py`` script.
    ...
    """The :class:`.MigrationContext` established by the ``.env.py.py`` script."""
