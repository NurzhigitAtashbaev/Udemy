...
def revision(
    ...
    if environment:
        ...
        # or at the end of .env.py.py run_migrations_online().
...
def upgrade(
    ...
    :param tag: an arbitrary "tag" that can be intercepted by custom
     ``.env.py.py`` scripts via the :meth:`.EnvironmentContext.get_tag_argument`
     method.
...
def stamp(
    ...
    :param tag: an arbitrary "tag" that can be intercepted by custom
     ``.env.py.py`` scripts via the :class:`.EnvironmentContext.get_tag_argument`
     method.
