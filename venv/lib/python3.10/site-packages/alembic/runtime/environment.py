...
class EnvironmentContext(util.ModuleClsProxy):
    ...
    """A configurational facade made available in an ``.env.py.py`` script.
    ...
    within the context of the ``.env.py.py`` script that is invoked by
    ...
    of the command.   From within an ``.env.py.py`` script, the current
    ...
    ``with:`` statement.  A typical use of :class:`.EnvironmentContext`::
        ...
        def my_function(rev, context):
            ...
            that the .env.py.py will create'''
    ...
    The above script will invoke the ``.env.py.py`` script
    within the migration environment.  If and when ``.env.py.py``
    ...
    .. note::
        ...
        ``.env.py.py`` module present in the migration environment.
    ...
    def get_tag_argument(self) -> Optional[str]:
        ...
        but is available for custom ``.env.py.py`` configurations that
        ...
        .. seealso::
            ...
            open ended system of extending ``.env.py.py`` scripts via the command
            line.
    ...
    def get_x_argument(
        ...
        here for consumption by a custom ``.env.py.py`` script.
        ...
        the standard ``.env.py.py`` script can be modified like this::
    ...
    def configure(
        ...
        **kw: Any,
        ...
        This function is typically called from the ``.env.py.py``
        ...
        :param starting_rev: Override the "starting revision" argument
         when using ``--sql`` mode.
        :param tag: a string tag for usage by custom ``.env.py.py`` scripts.
    ...
    def run_migrations(self, **kw: Any) -> None:
        ...
        database in use, can be passed from a custom ``.env.py.py`` script
    ...
    def begin_transaction(
        ...
        * Otherwise, calls :meth:`sqlalchemy.engine.Connection.begin`
        ...
        Note that a custom ``.env.py.py`` script which
