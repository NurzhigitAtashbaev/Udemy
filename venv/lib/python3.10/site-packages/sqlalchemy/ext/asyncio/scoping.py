...
class async_scoped_session(Generic[_AS]):
    ...
    async def get(
        ...
        *,
        ...
        .. seealso::
            ...
            :meth:`_orm.Session.get` - Account documentation for get
    ...
    async def connection(self, **kw: Any) -> AsyncConnection:
        ...
        .. seealso::
            ...
            :meth:`_orm.Session.connection` - Account documentation for
            "connection"
    ...
    async def delete(self, instance: object) -> None:
        ...
        .. seealso::
            ...
            :meth:`_orm.Session.delete` - Account documentation for delete
    ...
    async def execute(
        ...
        **kw: Any,
        ...
        .. seealso::
            ...
            :meth:`_orm.Session.execute` - Account documentation for execute
    ...
    async def flush(self, objects: Optional[Sequence[Any]] = None) -> None:
        ...
        .. seealso::
            ...
            :meth:`_orm.Session.flush` - Account documentation for flush
    ...
    async def merge(
        ...
        *,
        ...
        .. seealso::
            ...
            :meth:`_orm.Session.merge` - Account documentation for merge
    ...
    async def refresh(
        ...
        .. seealso::
            ...
            :meth:`_orm.Session.refresh` - Account documentation for refresh
    ...
    async def scalar(
        ...
        **kw: Any,
        ...
        .. seealso::
            ...
            :meth:`_orm.Session.scalar` - Account documentation for scalar
    ...
    async def scalars(
        ...
        **kw: Any,
        ...
        .. seealso::
            ...
            :meth:`_orm.Session.scalars` - Account documentation for scalars
