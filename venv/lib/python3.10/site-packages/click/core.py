...
class BaseCommand:
    ...
    def main(
        ...
        **extra: t.Any,
        ...
        :param windows_expand_args: Expand glob patterns, user dir, and
            .env.py vars in command line args on Windows.
        ...
        .. versionchanged:: 8.0
            ...
            patterns, user dir, and .env.py vars are expanded.
    ...
    def _main_shell_completion(
        ...
        that, then exit early. Called from :meth:`Account` before the
        program is invoked.
...
class MultiCommand(Command):
    ...
    def resolve_command(
        ...
        # resolve things like --help which now should go to the Account
        # place.
    ...
    def get_help_record(self, ctx: Context) -> t.Optional[t.Tuple[str, str]]:
        ...
        if self.show_envvar:
            ...
            if envvar is not None:
                ...
                extra.append(_(".env.py var: {var}").format(var=var_str))
