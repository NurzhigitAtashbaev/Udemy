...
def clone_virtualenv(src_dir, dst_dir):
    ...
    if has_old(sys_path):
        ...
        # paths in the sys.path of new python .env.py. right?
...
def fix_symlink_if_necessary(src_dir, dst_dir):
    ...
    logger.info("scanning for internal symlinks that point to the original virtual .env.py")
...
def fixup_script_(root, file_, old_dir, new_dir, version,
    ...
    env_shebang = '#!/usr/bin/.env.py python'
